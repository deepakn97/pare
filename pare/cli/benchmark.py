...
from pare.cli.utils import MODELS_MAP, LLMProbeError, probe_llm_endpoint
...
app = typer.Typer(
    name="benchmark",
    help="Run PARE benchmark experiments with config sweeps",
)
...
def _print_sweep_summary(
    ...
    all_results: dict[tuple[str, str, float, int], PAREMultiScenarioValidationResult],
