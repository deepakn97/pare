"""Scenario loader for PARE benchmark pipeline.

Loads scenarios from the PARE registry. Future versions will support
...
def get_splits_dir() -> Path:
    ...
    """
    env_path = os.environ.get("PARE_BENCHMARK_SPLITS_DIR")
    if env_path:
...
def load_scenarios_from_registry(
    ...
    """Load scenarios from PARE registry.
    ...
    Returns:
        CountableIterator of PAREScenario objects.
    """
    ...
    def generator() -> Iterator[PAREScenario]:
...
def load_scenarios_by_split(
    ...
    if not split_file.exists():
        raise FileNotFoundError(
            ...
            f"or set PARE_BENCHMARK_SPLITS_DIR environment variable."
        )
