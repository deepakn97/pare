...
from pare.trajectory.models import DecisionPoint as TernaryDecisionPoint  # noqa: TC001
from pare.trajectory.trace_parser import extract_decision_points as extract_ternary_decision_points
