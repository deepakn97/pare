...
Please confirm your assignments. Looking forward to working with everyone!
...
Best""",
    ...
    def validate(self, env: AbstractEnvironment) -> ScenarioValidationResult:
        ...
        try:
            ...
            # Check Step 6: Agent replied to Sarah confirming task ownership and deadlines
            # STRICT: Must reply to the correct email thread and mention the three tasks with dates
            # FLEXIBLE: Exact phrasing and date format can vary
            reply_found = any(
                (e.event_type == EventType.AGENT)
                and isinstance(e.action, Action)
                and e.action.class_name == "StatefulEmailApp"
            ...
            if not success:
                ...
                if not reply_found:
                    missing_checks.append("reply to Sarah confirming tasks and deadlines")
