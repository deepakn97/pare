...
class SubletInquiryResponseTriage(PASScenario):
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            # Oracle event 12: Agent sends summary to user highlighting priority
            summary_event = (
                aui.send_message_to_user(
                    content="I've sent personalized replies to all three inquiries with accurate details from your listing. Sarah Kim's inquiry is flagged as high-priority due to her urgent December timeline and strong interest. I recommend scheduling a showing with her first."
                )
                .oracle()
                .depends_on(reply_sarah_event, delay_seconds=2)
            )
    ...
    def validate(self, env: AbstractEnvironment) -> ScenarioValidationResult:
        ...
        try:
            ...
            apartment_details_accessed = any(
                ...
                and e.action.function_name in ["get_apartment_details", "list_saved_apartments"]
                for e in log_entries
            )
