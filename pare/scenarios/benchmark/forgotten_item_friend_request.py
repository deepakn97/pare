...
class ForgottenItemFriendRequest(PAREScenario):
    ...
    def build_events_flow(self) -> None:
        ...
        alex_user_id = messaging_app.name_to_id["Alex Johnson"]
        ...
        cab_service_phone = messaging_app.name_to_id["Cab Service"]
    ...
    def validate(self, env: AbstractEnvironment) -> ScenarioValidationResult:
        ...
        try:
            ...
            messaging_app = self.get_typed_app(StatefulMessagingApp, "Messages")
            alex_id = messaging_app.name_to_id["Alex Johnson"]
            ...
            alex_notification_found = any(
                ...
                and e.action.args.get("user_id") == alex_id
