...
class ApartmentMaintenanceCalendarCoordination(PAREScenario):
    ...
    def init_and_populate_apps(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.client_presentation_event_id = self.calendar.add_calendar_event(
            title="Client Presentation",
            start_datetime="2025-01-16 09:00:00",
            end_datetime="2025-01-16 11:00:00",
            tag="Work",
        ...
        self.sprint_planning_event_id = self.calendar.add_calendar_event(
