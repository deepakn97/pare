...
from pare.apps import HomeScreenSystemApp, PAREAgentUserInterface, StatefulContactsApp, StatefulMessagingApp
from pare.scenarios import PAREScenario
from pare.scenarios.utils.registry import register_scenario


@register_scenario("contact_update_from_new_number")
class ContactUpdateFromNewNumber(PAREScenario):
