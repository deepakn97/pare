...
class ProposeAndScheduleMeetingScenario(Scenario):
    ...
    def init_and_populate_apps(self, *args: Any, **kwargs: Any) -> None:
        ...
        print("[DEBUG] Cal002: Apps initialized")
    ...
    def validate(self, env: AbstractEnvironment) -> ScenarioValidationResult:
        ...
        try:
            ...
            print(f"[DEBUG] Cal002: event_created={event_created}")
            print(f"[DEBUG] Cal002: Total events in log: {len(events)}")

            success = event_created
            print(f"[INFO] Cal002: Validation result: success={success}")
