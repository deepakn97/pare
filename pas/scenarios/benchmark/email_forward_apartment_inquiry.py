...
class EmailForwardApartmentInquiry(PASScenario):
    ...
    partner's email to the property manager (so the original question/context is preserved). The agent must:
        ...
        with EventRegisterer.capture_mode():
            ...
            partner_email_event = email_app.send_email_to_user_with_id(
                ...
                content=(
                    ...
                    "Can you please forward this email to the property manager for the Riverside Towers Unit 402B listing you saved, so they see my exact question and can reply?"
                ),
            ).delayed(10)
            ...
            # details surfaced the property manager contact info via tools.
            proposal_event = (
