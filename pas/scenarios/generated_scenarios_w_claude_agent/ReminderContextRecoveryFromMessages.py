...
class ReminderContextRecoveryFromMessages(PASScenario):
    ...
    def init_and_populate_apps(self, *args: Any, **kwargs: Any) -> None:
        ...
        # Set current user for messaging
        user_id = "user_001"
        user_name = "Me"
        self.messaging.current_user_id = user_id
        self.messaging.current_user_name = user_name
        self.messaging.id_to_name[user_id] = user_name
        self.messaging.name_to_id[user_name] = user_id

        # Add Sarah Chen as a contact
        sarah_id = "sarah_chen_001"
        sarah_name = "Sarah Chen"
        self.messaging.id_to_name[sarah_id] = sarah_name
        self.messaging.name_to_id[sarah_name] = sarah_id
        ...
        conversation_with_sarah = ConversationV2(
            ...
            participant_ids=[user_id, sarah_id],
            title="Sarah Chen",
            messages=[
                MessageV2(
                    sender_id=sarah_id,
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            # Since update_reminder is not a decorated tool, we provide the context via message instead
