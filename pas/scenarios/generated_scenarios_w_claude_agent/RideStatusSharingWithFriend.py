...
class RideStatusSharingWithFriend(PASScenario):
    ...
    def build_events_flow(self) -> None:
        ...
        # Get Sarah's participant ID for messaging
        sarah_id = messaging_app.name_to_id["Sarah"]
        sarah_conversation_id = None
        for conv in messaging_app.conversations.values():
            if sarah_id in conv.participant_ids:
                sarah_conversation_id = conv.conversation_id
                break
