...
class DeliveryConflictCancellation(PASScenario):
    ...
    2. Check reminders and identify the conflicting "Out of town" reminder for the same day
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            # Motivated by: order details indicate delivery on Thursday (Nov 20), need to check availability
