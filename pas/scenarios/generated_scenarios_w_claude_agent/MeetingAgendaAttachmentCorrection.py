    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            incoming_email_event = email_app.send_email_to_user_with_id(
                ...
                content="Hi! Please update the agenda note attachments before tomorrow's meeting. Replace Budget_Draft_v2.xlsx with Budget_Final_v3.xlsx (path: /files/Budget_Final_v3.xlsx), and replace Roadmap_Draft.pptx with Roadmap_Approved.pptx (path: /files/Roadmap_Approved.pptx). The note title is 'Q1 Planning Meeting Agenda - Jan 15' in your Work folder. Thanks!",
            ).delayed(15)
