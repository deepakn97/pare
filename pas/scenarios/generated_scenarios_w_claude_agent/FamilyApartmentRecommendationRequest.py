        ...
        try:
            ...
            for e in agent_events:
                if e.action.class_name == "StatefulApartmentApp" and e.action.function_name == "search_apartments":
                    ...
                    if location == "Austin" and bedrooms == 2 and "pet" in pet_policy.lower() and max_price >= 2000:
                        search_found = True
                        break
            ...
            reply_found = False
            for e in agent_events:
                if e.action.class_name == "StatefulEmailApp" and e.action.function_name == "reply_to_email":
                    args = e.action.args if e.action.args else e.action.resolved_args
                    email_id = args.get("email_id", "")
