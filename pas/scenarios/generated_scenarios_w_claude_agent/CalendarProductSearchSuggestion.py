...
class CalendarProductSearchSuggestion(PASScenario):
    ...
    The user has a calendar event "Camping Trip at Yosemite" scheduled for next weekend with three attendees. A calendar notification fires reminding the user about the upcoming camping trip in 5 days. The agent must:
    ...
    3. Infer that camping trips typically require outdoor equipment
    4. Search the shopping catalog for relevant products using `search_product()` with camping-related terms (e.g., "tent", "sleeping bag")
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            packing_reminder_event = calendar_app.add_calendar_event_by_attendee(
                ...
                description="Reminder to pack all camping equipment before tomorrow's Yosemite trip, especially the tent and sleeping bags!!",
            ...
            proposal_event = (
                aui.send_message_to_user(
                    content="I noticed your camping trip at Yosemite is coming up soon. Would you like help finding camping supplies? I can search for tents, sleeping bags, and other essentials."
                )
                .oracle()
