...
class BudgetConstrainedApartmentFilter(PASScenario):
    ...
    The user has saved five apartments to their favorites with varying monthly rents ($1800, $2200, $2500, $2800, $3200). An email arrives from the user's roommate stating "Hey, I can only afford up to $2400/month for rent. Can you make sure we're only looking at places within that budget?" The agent must:
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            env_event_1 = email_app.send_email_to_user_with_id(
                ...
                content="Hey! I've been looking at our finances and I can only afford up to $2400/month for rent. Can you make sure we're only looking at places within that budget? Thanks!",
            )
