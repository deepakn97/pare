...
class NoteAttachmentEmailForwarding(PASScenario):
    ...
    def init_and_populate_apps(self, *args: Any, **kwargs: Any) -> None:
        ...
        Baseline state:
        - Email: User is alex.morgan@company.com
        ...
        note = work_folder.get_note_by_id(note_id)
        if note:
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            get_note_event = (
                note_app.get_note_by_id(note_id=self.note.folders["Work"].search_notes("Q1 Budget Planning")[0].note_id)
                .oracle()
            ...
            list_attachments_event = (
                note_app.list_attachments(
                    note_id=self.note.folders["Work"].search_notes("Q1 Budget Planning")[0].note_id
                )
                .oracle()
