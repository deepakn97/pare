...
class AddMissingGroupContacts(PASScenario):
    ...
    def build_events_flow(self) -> None:
        ...
        # Retrieve the conversation_id and participant IDs from the messaging app
        book_club_conv = next(iter(messaging_app.conversations.values()))
        conversation_id = book_club_conv.conversation_id
