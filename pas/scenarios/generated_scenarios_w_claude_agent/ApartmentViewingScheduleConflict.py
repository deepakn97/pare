...
class ApartmentViewingScheduleConflict(PASScenario):
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            acceptance_event = (
                aui.accept_proposal(content="Yes, please reschedule both viewings and notify the property managers.")
                .oracle()
    ...
    def validate(self, env: AbstractEnvironment) -> ScenarioValidationResult:
        ...
        try:
            ...
            thursday_check_found = any(
                ...
                and "2025-11-20 10:00:00" in str(e.action.args.get("start_datetime", ""))
                for e in agent_entries
            )
            ...
            friday_check_found = any(
                ...
                and e.action.function_name in ["get_calendar_events_from_to", "list_calendar_events", "search_events"]
                and (
                    "2025-11-21 14:00:00" in str(e.action.args.get("start_datetime", ""))
                    or "2025-11-21 15:00:00" in str(e.action.args.get("end_datetime", ""))
                )
                for e in agent_entries
            )
