...
class CorrectMisaddressedEmailTypo(PASScenario):
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            # Oracle Event 2: Agent reads the reply email to understand the error
            read_sent_event = (
