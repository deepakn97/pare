...
class TravelConflictRecurringMeeting(PASScenario):
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            # Agent needs to verify what's scheduled for the travel day
    ...
    def validate(self, env: AbstractEnvironment) -> ScenarioValidationResult:
        ...
        try:
            ...
            # Check Step 3b: Agent sent email to all three attendees about the reschedule
            # STRICT: Must email all three attendees (Sarah, Michael, Alex) with reschedule info
            # FLEXIBLE: Subject and body wording can vary, order doesn't matter
            notify_attendees_found = any(
                (e.event_type == EventType.AGENT)
                and isinstance(e.action, Action)
                and e.action.class_name == "StatefulEmailApp"
                and e.action.function_name == "send_email"
                and all(
                    email in e.action.args.get("recipients", [])
                    for email in [
                        "sarah.johnson@company.com",
                        "michael.chen@company.com",
                        "alex.rivera@company.com",
            ...
            success = proposal_found and calendar_check_found and edit_meeting_found and notify_attendees_found
            ...
            if not success:
                ...
                if not notify_attendees_found:
                    missing_checks.append("email notification to all three attendees")
