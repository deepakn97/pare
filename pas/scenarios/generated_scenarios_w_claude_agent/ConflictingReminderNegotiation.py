...
class ConflictingReminderNegotiation(PASScenario):
    ...
    def init_and_populate_apps(self, *args: Any, **kwargs: Any) -> None:
        ...
        casey_conv = ConversationV2(
            participant_ids=["user_main", casey_id],
            title="Casey",
        )
        alex_conv = ConversationV2(
            participant_ids=["user_main", alex_id],
            title="Alex",
        )
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            acceptance = (
                aui.accept_proposal(
                    content="Yes, that sounds good. Please create the reminder and reply to Jordan, Casey, and Alex explaining the consensus time choice and asking for confirmation."
                )
                .oracle()
        ...
        try:
            ...
            if not success:
                ...
                if not all_conversations_read:
                    failures.append("not all three conversations (Jordan, Casey, Alex) were read")
