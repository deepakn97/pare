...
class MeetingNotesFromMessages(PASScenario):
    ...
    def init_and_populate_apps(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.messaging.current_user_id = user_contact.phone
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            msg3 = messaging_app.create_and_add_message(
                conversation_id=sarah_conversation_id,
                sender_id=sarah_phone,
                content="Action items: David to finalize backend architecture by Nov 25. You need to draft product specs by Nov 22. Emily will prepare marketing materials by Dec 1. I'll handle design mockups by Nov 28. It's always a good habitat to save those important info into your notes!",
            ).delayed(4)
