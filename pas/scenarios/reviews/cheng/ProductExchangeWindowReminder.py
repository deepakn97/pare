    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            env_event_1 = calendar_app.add_calendar_event_by_attendee(
                ...
                tag="reminder",
                description="Last day to cancel Professional Laptop 15-inch ordered on 2025-11-04. Order ID: order_laptop_20251104",
            )
            ...
            oracle_event_4 = (
                ...
                .oracle()
                .depends_on([env_event_2], delay_seconds=10)
            )

            # Agent oracle event: Agent retrieves discount code info for the upgraded laptop
            # Evidence: the upgraded laptop notification should mention discount availability
            oracle_event_5 = (
                shopping_app.get_discount_code_info(discount_code="UPGRADE2025")
                .oracle()
                .depends_on([oracle_event_4], delay_seconds=5)
            )
