...
class RideReceiptBillingDispute(PASScenario):
    ...
    def init_and_populate_apps(self, *args: Any, **kwargs: Any) -> None:
        ...
        user_contact = Contact(
            first_name="Alex",
            last_name="Chen",
            email=self.email.user_email,
            phone="+1-555-0123",
            is_user=True,
        )

        # Cab company billing contact
        cab_billing_contact = Contact(
            first_name="Billing",
        ...
        actual_ride = Ride(
            ride_id="ride_20251117_140000",
            status="COMPLETED",
            service_type="Default",
            start_location="Central Station",
            end_location="450 Oak Avenue",
            price=16.50,  # Correct price: 15km * $1.00/km + small variance
            duration=18.0,  # 18 minutes
            time_stamp=yesterday_ride_time,
            distance_km=15.0,
            delay=None,
        )
        self.cab.ride_history.append(actual_ride)
        self.cab.quotation_history.append(actual_ride)
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            receipt_email_event = email_app.send_email_to_user_with_id(
                ...
                content="""Dear Alex Chen,

Thank you for riding with QuickRide!

Ride Details:
- Ride ID: ride_20251117_140000
...
QuickRide Billing Team""",
            ...
            dispute_email_event = (
                email_app.send_email(
                    ...
                    subject="Billing Dispute - Ride ID ride_20251117_140000",
                    content="""Dear QuickRide Billing Team,

I am writing to dispute the charge on the receipt I received for ride ID ride_20251117_140000.
