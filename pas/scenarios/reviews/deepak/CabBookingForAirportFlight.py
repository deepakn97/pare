...
class CabBookingForAirportFlight(PASScenario):
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            # Oracle Event 1: Agent searches calendar for the flight event mentioned in the email
            # Motivated by: the flight confirmation email mentions December 20, 3:00 PM
            calendar_search_event = (
                calendar_app.get_calendar_events_from_to(
                    start_datetime="2024-12-20 14:00:00",
                    end_datetime="2024-12-20 16:00:00",
                )
                .oracle()
