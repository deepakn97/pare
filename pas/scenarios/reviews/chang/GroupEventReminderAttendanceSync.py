...
class GroupEventReminderAttendanceSync(PASScenario):
    ...
    def init_and_populate_apps(self, *args: Any, **kwargs: Any) -> None:
        ...
        # Create contacts for the three people who will send messages
        jordan_id = "jordan_contact_id"
        taylor_id = "taylor_contact_id"
        casey_id = "casey_contact_id"

        # Add users to messaging app name/id maps
        ...
        potluck_reminder = Reminder(
            reminder_id="potluck_reminder_id",
            title="Team Potluck Dinner",
            due_datetime=datetime(2025, 11, 19, 18, 0, 0, tzinfo=UTC),
        ...
        self.reminder.reminders[potluck_reminder.reminder_id] = potluck_reminder
