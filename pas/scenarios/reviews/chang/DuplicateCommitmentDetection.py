        ...
        with EventRegisterer.capture_mode():
            ...
            proposal_event = (
                aui.send_message_to_user(
                    content="I noticed you have 'Dinner with Mom' on your calendar for Saturday Nov 23 at 7 PM, but your group chat mentions Mike's birthday dinner at the same time tomorrow. These appear to be two different commitments. Would you like me to help reschedule one of them?",
                )
                .oracle()
                .depends_on(check_calendar_event, delay_seconds=2)
            )

            # Oracle Event 5: User accepts proposal and chooses which to reschedule
            acceptance_event = (
                aui.accept_proposal(
                    content="Yes, please reschedule dinner with Mom to Sunday evening and let her know.",
                )
                .oracle()
