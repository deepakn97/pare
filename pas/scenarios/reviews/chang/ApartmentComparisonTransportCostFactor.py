...
class ApartmentComparisonTransportCostFactor(PASScenario):
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            # User explicitly asks the agent to do the commute comparisons using cab tools.
            user_request_compare_event = (
                aui.accept_proposal(
                    content="Yes—please compare them using commute costs from my ride history. Use 777 Corporate Blvd as the location of my workplace, then get quotations from each apartment to work."
                )
                .oracle()
