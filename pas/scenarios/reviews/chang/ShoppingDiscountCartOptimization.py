...
class ShoppingDiscountCartOptimization(PASScenario):
    ...
    def init_and_populate_apps(self, *args: Any, **kwargs: Any) -> None:
        ...
        # Set up discount codes for specific items
        # SAVE20 applies to headphones and laptop stand (not cable)
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            # This notification announces the SAVE20 discount code for eligible items
            discount_notification_event = shopping_app.add_discount_code(
                item_id=self.headphones_black_item_id,
                discount_code={"SAVE20PROMO": 20.0},
            ).delayed(10)
