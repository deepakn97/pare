...
class MidRideUrgentDiversion(PASScenario):
    ...
    def init_and_populate_apps(self, *args: Any, **kwargs: Any) -> None:
        ...
        # Add contact: Sam (roommate)
        sam_contact_id = "sam_001"
        self.messaging.id_to_name[sam_contact_id] = "Sam"
        self.messaging.name_to_id["Sam"] = sam_contact_id
        ...
        self.cab.ride_history.append(ongoing_ride)
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            # Agent gets a quotation for the diverted route: current location → Sam's workplace → airport
            ...
            proposal_event = (
                aui.send_message_to_user(
                    content="I saw Sam's message about your laptop charger. I can modify your current airport ride to stop at Sam's workplace (456 Innovation Drive) to pick it up. This will require canceling the current ride and booking a new one with the detour. The total journey will take longer but you'll still make your flight. Would you like me to proceed?"
                )
                .oracle()
            ...
            # Motivated by: Must cancel current direct ride before booking new multi-stop route
            cancel_event = cab_app.user_cancel_ride().oracle().depends_on(acceptance_event, delay_seconds=2)

            # Agent books new ride: home → Sam's workplace (first leg)
