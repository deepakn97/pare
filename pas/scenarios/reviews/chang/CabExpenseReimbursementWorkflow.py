...
class CabExpenseReimbursementWorkflow(PASScenario):
    ...
    1. Parse the email to extract the reimbursement deadline (Dec 27th), time window (last 7 days = Dec 16-23), and submission instructions (forward to accounting@company.com)
    ...
    5. Forward the original policy email as an attachment/reference in the same message

    This scenario exercises email-triggered administrative workflows, cab ride history retrieval (not booking), multi-ride data aggregation, email forwarding and structured composition with specific formatting requirements.
    """
