...
class RideCancelAfterHomeDelivery(PASScenario):
    ...
    def init_and_populate_apps(self, *args: Any, **kwargs: Any) -> None:
        ...
        bluetooth_speaker_product = Product(name="Bluetooth Speaker", product_id="bluetooth_speaker_prod_001")
        bluetooth_speaker_item = Item(
            item_id="bluetooth_speaker_item_001",
            price=79.99,
            available=True,
            options={"color": "black", "brand": "SoundPro"},
        )
        bluetooth_speaker_product.variants["bluetooth_speaker_item_001"] = bluetooth_speaker_item
        self.shopping.products["bluetooth_speaker_prod_001"] = bluetooth_speaker_product
        ...
        bluetooth_order = Order(
            order_id="order_bluetooth_001",
            order_status="shipped",
            order_date=order_time,
            order_total=79.99,
            order_items={"bluetooth_speaker_item_001": order_item},
        )
        self.shopping.orders["order_bluetooth_001"] = bluetooth_order
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            # This represents the Bluetooth Speaker being delivered earlier than expected
