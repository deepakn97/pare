...
class AbstractAgentBuilder(ABC):
    """Abstract class for building PAS agents."""
...
class UserAgentBuilder(AbstractAgentBuilder):
    ...
    def build(
        ...
        match agent_config.get_agent_name():
            case "default":
                from pas.agents.agent_factory import create_default_user_agent
    ...
    def build(
        ...
        match agent_config.get_agent_name():
            case "observe-execute":
                from pas.agents.agent_factory import create_observe_execute_proactive_agent
