"""Tests for PAREScenario base class."""
...
class TestPAREScenarioApplyAugmentationConfigs:
    """Tests for PAREScenario.apply_augmentation_configs method."""

    def test_sets_failure_probability_on_apps(self) -> None:
        """Should set failure probability on all apps."""

        class TestScenario(PAREScenario):
...
class TestPAREScenarioInitialize:
    """Tests for PAREScenario.initialize method."""
    ...
    def test_uses_pare_env_events_expander_when_config_set(self) -> None:
        """Should use PAREEnvEventsExpander when env_events_config is set."""
        ...
        with patch("pare.scenarios.scenario.PAREEnvEventsExpander") as mock_expander_class:
            ...
            # Verify PAREEnvEventsExpander was instantiated and called
    ...
    def test_skips_env_events_when_no_config(self) -> None:
        ...
        with patch("pare.scenarios.scenario.PAREEnvEventsExpander") as mock_expander_class:
            ...
            # PAREEnvEventsExpander should not be instantiated
